...
def GetDataframe(global_user, port_file):
    if len(os.listdir(ROOT_PATH + "/Analysis/Visualization/" + port_file + "/" + global_user)) != 0:
        ...
        stacked_dataframe['reels'] = 0
        stacked_dataframe['story'] = 0
        stacked_dataframe['IG_comment'] = 0
        stacked_dataframe['video_action'] = 0
        stacked_dataframe['shorts'] = 0
        stacked_dataframe['video'] = 0
        stacked_dataframe['YT_comment'] = 0
